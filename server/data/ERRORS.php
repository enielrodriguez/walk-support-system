...
class ERRORS
{
    ...
    const COMPANY_EXISTS = 'COMPANY_EXISTS';
    const INVALID_NIT = 'INVALID_NIT';
    const INVALID_PHONE = 'INVALID_PHONE';
    const INVALID_CONTACT_NAME = 'INVALID_CONTACT_NAME';
    ...
    const USERS_LIMIT_REACHED = 'USERS_LIMIT_REACHED';
    const COMPANIES_LIMIT_REACHED = 'COMPANIES_LIMIT_REACHED';
    const DEPARTMENTS_LIMIT_REACHED = 'DEPARTMENTS_LIMIT_REACHED';
    const STAFF_LIMIT_REACHED = 'STAFF_LIMIT_REACHED';

    const INVALID_USERS_LIMIT = 'INVALID_USERS_LIMIT';
