...
class ERRORS
{
    ...
    public const USERS_LIMIT_EXCEEDED = 'USERS_LIMIT_EXCEEDED';
    public const COMPANIES_LIMIT_EXCEEDED = 'COMPANIES_LIMIT_EXCEEDED';
    public const DEPARTMENTS_LIMIT_EXCEEDED = 'DEPARTMENTS_LIMIT_EXCEEDED';
    public const STAFF_LIMIT_EXCEEDED = 'STAFF_LIMIT_EXCEEDED';
}
