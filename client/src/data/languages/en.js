export default {
    ...
    'CUSTOM_RESPONSES': 'Default Responses',
    ...
    'ADD_STAFF': 'Add staff',
    'LEVEL': 'Level',
    'LEVEL_1': 'Level 1 (Tickets & Users)',
    'LEVEL_2': 'Level 2 (Level 1 + Articles)',
    'LEVEL_3': 'Admin (Unlimited access)',
    ...
    'ALLOWED_LANGUAGES': 'GUI Languages',
    'ALLOWED_LANGUAGES_INFO': 'GUI languages are the languages in which a user can view the website',
    ...
    'CUSTOM_RESPONSES_DESCRIPTION': 'Default responses are automated responses for common problems',
    ...
    'EMAIL_TEMPLATES_DESCRIPTION': 'Here you can edit the templates of the emails that will be sent to users. Remember that the double curly braces indicate a variable value. For example, {name} represents the user\'s name',
    ...
    'SUPERVISOR_CAN_NOT_SUPERVISE_HIMSELF': 'The company administrator cannot be added',
    ...
    'SUPERVISED_USERS_INFO': 'These users belong to the same company, and are managed by the current user',
    'EDIT_USER': 'Edit User',
