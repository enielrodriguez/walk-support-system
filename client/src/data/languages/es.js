export default {
    ...
    'DESCRIPTION_EDIT_CUSTOM_TAG': 'Aquí puede editar una etiqueta personalizada',
    ...
    'ALL_TICKETS_DESCRIPTION': 'Aquí puede ver los tickets de los departamentos a los cuales está asignado',
    'TICKET_VIEW_DESCRIPTION': 'Este ticket ha sido enviado por un cliente. Aquí puede responderlo o asignarlo',
    'BAN_USERS_DESCRIPTION': 'Aquí puede ver la lista de emails bloqueados. Puede desbloquear o agregar más emails a la lista',
    ...
    'STAFF_MEMBERS_DESCRIPTION': 'Aquí puede ver quiénes son los miembros del personal de soporte',
    'ADD_STAFF_DESCRIPTION': 'Use este formulario para agregar miembros al personal',
    'EDIT_STAFF_DESCRIPTION': 'Aquí puede editar información sobre un miembro del personal',
    'MY_ACCOUNT_DESCRIPTION': 'Aquí puede editar información acerca de usted',
    'DEPARTMENTS_DESCRIPTION': 'Un departamento es un grupo donde los tickets pueden ir. Se utilizan para categorizar los tickets. Puede asignarlos a otros miembros del personal',
    ...
    'EMAIL_TEMPLATES_DESCRIPTION': 'Aquí puede editar las plantillas de los correos electrónicos que se enviarán a los usuarios. Recuerde que las llaves dobles indican un valor variable. Por ejemplo, {name} representa el nombre del usuario',
    ...
    'ADVANCED_SETTINGS_DESCRIPTION': 'Aquí puede cambiar la configuración avanzada del sistema. Tenga cuidado, algunos cambios no se pueden revertir',
    ...
    'EDIT_PROFILE_VIEW_DESCRIPTION': 'Aquí puede editar algunos de sus datos',
    ...
    'EMAIL_SETTINGS_DESCRIPTION': 'Aquí puede editar la configuración para recibir y enviar correos electrónicos de sus clientes',
    'IMAP_POLLING_DESCRIPTION': 'La verificación de la bandeja de entrada no se hará automáticamente por F2F. Debe realizar solicitudes POST periódicamente a esta URL para procesar los correos electrónicos: {url}',
    ...
    'INVITE_USER_VIEW_DESCRIPTION': 'Aquí puede añadir un usuario a nuestro sistema de soporte',
    'ERROR_NAME': 'Nombre incorrecto',
    'INVITE_STAFF_DESCRIPTION': 'Aquí puede añadir los miembros del equipo de soporte',
    ...
    'LIST_COMPANIES_DESCRIPTION': 'Esta es la lista de empresas que están registradas en el sistema',
    ...
    'ADD_COMPANY_VIEW_DESCRIPTION': 'Aquí puede añadir una empresa a nuestro sistema de soporte',
